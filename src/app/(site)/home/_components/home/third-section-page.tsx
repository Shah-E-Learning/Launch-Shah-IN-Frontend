...
const RippleCard: React.FC<RippleCardProps> = ({ card }) => {
  ...
  return (
    <>
      {/* ───── Card ───── */}
      <div
        className='group relative h-full cursor-pointer overflow-hidden rounded-3xl bg-[#f0f9f9] p-6 transition-all duration-300 ease-in-out hover:bg-mainColor'
...
const CardSection: React.FC = () => {
  return (
    <ScreenWrapper className='py-10 lg:py-10'>
      <div className='mb-8 text-center'>
        <h2 className='main-title mb-4 font-bold text-mainColor'>Empowering Homeopaths to Heal, Serve and Thrive:</h2>
