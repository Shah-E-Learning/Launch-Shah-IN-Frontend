...
//   return (
//     <ScreenWrapper className='py-4' id='inaguration'>
...
//           <div className='text-center text-xl sm:text-2xl lg:text-3xl xl:text-5xl'>
...
//           <p className='text-center font-serif text-xl font-bold !leading-[2.5rem] tracking-wide text-amber-500 sm:text-2xl lg:text-3xl lg:!leading-[6rem] xl:text-5xl'>
...
//           <div className='text-center text-xl font-bold tracking-wide sm:text-2xl lg:text-3xl xl:text-5xl'>
//             <h1 className='leading-tight'>
...
//             <h1 className='text-xl leading-relaxed sm:text-xl sm:leading-relaxed md:text-2xl md:leading-snug lg:text-3xl lg:leading-normal xl:text-5xl xl:leading-[4rem] 2xl:text-5xl 2xl:leading-[4.5rem]'>
//               <span className='font-bold'>S</span>
  ...
  return (
    <ScreenWrapper className='py-4'>
      <div className='relative z-10 grid grid-cols-1 gap-2 rounded-[30px] bg-mainColor to-transparent text-white md:ps-6 lg:grid-cols-12 lg:gap-8 lg:ps-16'>
        ...
        <div className='order-2 space-y-4 py-4 lg:order-1 lg:col-span-7 lg:py-16'>
          {/* Title */}
          <div className='text-center text-3xl sm:text-4xl lg:text-4xl xl:text-5xl'>
            <h1 className='leading-tight'>
              <span className='font-bold'>S</span>
              <span className='front-medium'>amuel</span> <span className='font-bold'>H</span>
              <span className='front-medium'>ahnemann</span> <span className='font-bold'>A</span>
          ...
          <div className='flex justify-center'>
            <span className='main-description text-muted-foreground text-center! font-normal leading-snug'>of the course</span>
          </div>

          {/* <p className='font-bold text-3xl sm:text-4xl lg:text-4xl xl:text-5xl text-center tracking-wide'>
          ...
          <div className='flex justify-center'>
            <span className='main-description text-muted-foreground text-center! font-normal leading-snug'>and</span>
          </div>
        ...
        <div className='relative order-1 flex items-end justify-center text-center lg:order-2 lg:col-span-5'>
          <Image
            ...
            width={719}
            height={699}
            className='h-auto w-full mt-5 md:mt-0 max-w-[200px] object-contain lg:max-w-[500px] xl:max-w-[659px]'
            priority
          />
          {/* <Image
            src={bgImage}
